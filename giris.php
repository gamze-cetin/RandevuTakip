...
<body class="bg-gradient-primary">
     ...
     <div class="container mt-5">
        <div class="row">
            <div class="col-md-6 mx-auto">
                <div class="card">
                    <div class="card-header">
                        <h4 class="font-weight-bold text-primary text-center">Hoşgeldiniz</h4>
                    </div>
                    <div class="card-body">
                        ...
                        <form action="" method="POST" accept-charset="utf-8">
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <h5 class="text-center">Bizimle İletişime Geçmek İçin </h5>
                                    <h6 class="text-center">xxxxxxxxxx</h5>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <h5 class="text-center">Şubelerimiz </h5>
                                    <h6 class="text-center">Ankara, İstanbul, Bursa</h5>
                                </div>
                            </div>
    ...
    <!-- Bootstrap,JavaScript entegrasyonu-->
