    ...
    <!-- Bootstrap ve JavaScript entegrasyonu-->
    <script src="vendor/jquery/jquery.min.js"></script>
    <script src="vendor/bootstrap/js/bootstrap.bundle.min.js"></script>

    <!-- JavaScript önyüklemesi-->
...
<script>
  var dildosyasi={
 <!--kolaylık olması açısından daha kapsamlı bir tablo ve bu tablonu türkçe dili entegre edildi-->
...
<!--Düzenlendiğine dair olumlu ya da olumsuz bilgilendirme -->
